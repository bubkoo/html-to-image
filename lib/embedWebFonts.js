        ...
        return __generator(this, function (_a) {
            ...
            styleSheets.forEach(function (sheet) {
                if ('cssRules' in sheet) {
                    try {
                        (0, util_1.toArray)(Object.prototype.hasOwnProperty.call(sheet, 'cssRules')).forEach(function (item, index) {
                        ...
                        if (sheet.href != null) {
                            deferreds.push(fetchCSS(sheet.href)
                                ...
                                .then(function (cssText) {
                                return parseCSS(cssText).forEach(function (rule) {
                                    inline_1.insertRule(rule, Object.prototype.hasOwnProperty.call(sheet, 'cssRules')
                                        .length);
                                });
                            })
                                .catch(function (err) {
            ...
            return [2 /*return*/, Promise.all(deferreds).then(function () {
                    ...
                    styleSheets.forEach(function (sheet) {
                        if ('cssRules' in sheet) {
                            try {
                                (0, util_1.toArray)(Object.prototype.hasOwnProperty.call(sheet, 'cssRules')).forEach(function (item) {
                                    ret.push(item);
                                });
                            }
                            catch (e) {
